...
<div class="colContent">
		...
		<table align="center" style="width: 100%;" border="1"><tr><td width="8" style="background-color:#aba18d;color:black;"><center>Place</center></td><td width="30" style="background-color:#aba18d;"><img title="Race" alt="Race" src='img/heads/0.png '></td><td width="180" style="background-color:#aba18d;"><b><center style="color:#000000">Nom</center></b></td><td width="40" style="background-color:#aba18d;"><b><center style="background-color:#aba18d;color:#000000;">Level</center></b></td><td width="30" style='background-color:#aba18d;'><center><img title="Alignement" alt="Alignement" src='img/heads/align/5.png '/></center></td><td width="100" style="background-color:#aba18d;"><center><b style="color:#000000">Honneur</b></center></td></tr>
<?php
try
	{
	...
	$personnages= $bdd->prepare('SELECT class, name, sexe, level, alignement, honor FROM personnages ORDER BY level DESC LIMIT 0, 50');
	$personnages->execute();
	for ($place = 1; $place <= 50; $place++)
		{
		$donnees = $personnages->fetch();
		if (isset ($donnees['name']))
			...
			switch ($place)
				...
				case 1:
					...
					<img src=\'img/heads/'.$donnees['class'].'.png\'></td><td style="color:#000000;background-color:#e3b74e"><font color="black">'.$donnees['name'].'</font><span style="float: right;">
					<img alt="Sexe" title="Sexe" class="icon_li"src="img/devtool/'.$donnees['sexe'].'.png"></span>
					</td><td style="color:#000000;background-color:#e3b74e"><b><center><font color="black">'.$donnees['level'].'</font></center></b></td><td style="color:#000000;background-color:#e3b74e"><center><img alt=\'Alignement\' title=\'Alignement\' src=\'img/heads/align/'.$donnees['alignement'].'.png\'></center></td><td style="color:#000000;background-color:#e3b74e">
					<center><font color="black">'.$donnees['honor'].'</font></center></td></tr>';
				break;
				case 2:
					...
					<img src=\'img/heads/'.$donnees['class'].'.png\'></td><td style="color:#000000;background-color:#a1a1a1"><font color="black">'.$donnees['name'].'</font><span style="float: right;">
					<img alt="Sexe" title="Sexe" class="icon_li"src="img/devtool/'.$donnees['sexe'].'.png"></span>
					</td><td style="color:#000000;background-color:#a1a1a1"><b><center><font color="black">'.$donnees['level'].'</font></center></b></td><td style="color:#000000;background-color:#a1a1a1"><center><img alt=\'Alignement\' title=\'Alignement\' src=\'img/heads/align/'.$donnees['alignement'].'.png\'></center></td><td style="color:#000000;background-color:#a1a1a1">
					<center><font color="black">'.$donnees['honor'].'</font></center></td></tr>';
				break;
				case 3:
					...
					<img src=\'img/heads/'.$donnees['class'].'.png\'></td><td style="color:#000000;background-color:#c07140"><font color="black">'.$donnees['name'].'</font><span style="float: right;">
					<img alt="Sexe" title="Sexe" class="icon_li"src="img/devtool/'.$donnees['sexe'].'.png"></span>
					</td><td style="color:#000000;background-color:#c07140"><b><center><font color="black">'.$donnees['level'].'</font></center></b></td><td style="color:#000000;background-color:#c07140"><center><img alt=\'Alignement\' title=\'Alignement\' src=\'img/heads/align/'.$donnees['alignement'].'.png\'></center></td><td style="color:#000000;background-color:#c07140">
					<center><font color="black">'.$donnees['honor'].'</font></center></td></tr>';
				break;
				
				default:
					echo '<tr><td style="color:#000000;background-color:#e3b74e"><center>
					'.$place.'</center></td><td style="color:#000000;background-color:#e3b74e" width="30">
					<img src=\'img/heads/'.$donnees['class'].'.png\'></td><td style="color:#000000;background-color:#e3b74e"><font color="black">'.$donnees['name'].'</font><span style="float: right;">
					<img alt="Sexe" title="Sexe" class="icon_li"src="img/devtool/'.$donnees['sexe'].'.png"></span>
					</td><td style="color:#000000;background-color:#e3b74e"><b><center><font color="black">'.$donnees['level'].'</font></center></b></td><td style="color:#000000;background-color:#e3b74e"><center><img alt=\'Alignement\' title=\'Alignement\' src=\'img/heads/align/'.$donnees['alignement'].'.png\'></center></td><td style="color:#000000;background-color:#e3b74e">
					<center><font color="black">'.$donnees['honor'].'</font></center></td></tr>';
